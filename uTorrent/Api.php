...
define("UTORRENT_TORRENT_DOWNLOAD_URL", 19);
define("UTORRENT_TORRENT_RSS_FEED_URL", 20);
define("UTORRENT_TORRENT_STATUS_MESSAGE", 21);
define("UTORRENT_TORRENT_STREAM_ID", 22);
define("UTORRENT_TORRENT_DATE_ADDED", 23);
define("UTORRENT_TORRENT_DATE_COMPLETED", 24);
define("UTORRENT_TORRENT_APP_UPDATE_URL", 25);
define("UTORRENT_TORRENT_SAVE_PATH", 26);
